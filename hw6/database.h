...
public:
	...
	void query(std::string query_file, std::string output_file, int time, double theta);
	std::vector<std::string> pagerank(std::vector<std::string> vec, int time, double theta);
